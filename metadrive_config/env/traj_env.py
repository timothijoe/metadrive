...
from metadrive_config.utils.discrete_policy import DiscreteMetaAction
from metadrive_config.utils.agent_manager_utils import MacroAgentManager
from metadrive_config.utils.engine_utils import initialize_engine, close_engine, \
    engine_initialized, set_global_random_seed, MacroBaseEngine
from metadrive_config.utils.traffic_manager_utils import TrafficMode
from metadrive_config.utils.observation_utils import HRLTopDownMultiChannel
...
from metadrive_config.utils.traj_decoder import VaeDecoder
...
class MetaDriveTrajEnv(BaseEnv):
    ...
    def __init__(self, config: dict = None):
        ...
        vae_load_dir = '/home/zhoutong/dir_sda/betty/LightZero/zoo/metadrive/model/nov02_len10_dim3_v1_ckpt'
    ...
    def setup_engine(self):
        ...
        from metadrive_config.utils.traffic_manager_utils import MacroTrafficManager
        from metadrive_config.utils.map_manager_utils import MacroMapManager
