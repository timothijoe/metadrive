...
def main(cfg, seed=0, max_iterations=int(1e10)):
    ...
    evaluator_cfg = dict(use_render=True)
    ...
    import torch
    policy._load_state_dict_eval(torch.load('/home/SENSETIME/zhoutong/hoffnung/metadrive/ckpt/iteration_30000.pth.tar', map_location = 'cpu'))
